...
\begin{frame}
	\pause
	\frametitle{Zum Vergleich des Quotienten- und Wurzelkriteriums}
	...
	Das Quotientenkriterium ist hier also im Gegensatz zum Wurzelkriterium nicht anwendbar\footnote<4->{Man beachte, dass man auch unter Verwendung der Variante des Quotientenkriteriums mit Limes superior und Limes inferior keine Aussage erhält.}.
\end{frame}
\end{document}
