...
[Foliensatz](../../assets/2026/tut02/presentation.pdf)

## Kurzprotokoll

Nach kurzer Besprechung der Präsentation wurden Aufgaben 2 und der erste Teil von Aufgabe 1 besprochen.
Der Rest wird in der kommenden Woche zu Beginn des Tutoriums kurz nachgeholt werden (wer möchte, kann schonmal unten ein paar Informationen einsehen oder zum Satz von Green nachlesen).

## Zum Mitnehmen

### Aufgabe 1
- Bei Aufgabenteil (i) sind viele verschiedene mögliche Lösungswege ersichtlich: Finden einer Stammfunktion (diese haben wir im Tutorium besprochen), aufteilen der Reihe in Hauptteil und "tail", majorisierte/dominierte Konvergenz, Fubini oder gleichmäßige Konvergenz von Potenzreihen auf Kreisscheiben innerhalb des Konvergenzkreises.
  Insgesamt ist wichtig, gut das Verhalten von (Potenz-)Reihen oder allgemeiner von Grenzwerten im Zusammenhang mit Integralen zu verstehen.
